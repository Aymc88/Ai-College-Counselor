          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 flex-1 min-h-0">
            ...
            <div className="lg:col-span-3 flex flex-col">
              <div className="flex flex-col">
                <div className="grid grid-cols-3 gap-[16.24px] overflow-y-auto pr-2 no-scrollbar" style={{ width: '565px', height: '565px' }}>
                  ...
                  {/* Financial Aid Agent Card */}
                  <Link href="/financial-aid" className="group">
                    <div className="relative h-full">
                      <div className="absolute -inset-0.5 bg-gradient-to-r from-green-500 to-green-600 rounded blur opacity-50 group-hover:opacity-100 transition duration-300" />
                      <div className="relative bg-slate-900 rounded p-1.5 border border-green-500 flex flex-col items-center justify-center gap-0.5 hover:bg-slate-800 transition aspect-square h-full">
                        <DollarSign className="w-14 h-14 text-green-400" />
                        <span className="text-2xl font-bold text-white text-center leading-tight">Financial Aid Agent</span>
                      </div>
                    </div>
                  </Link>
